...
@Component
class KafkaProducer(private val producerId: String) {
    ...
    fun product(topic: String, message: KafkaMessage): Mono<SenderResult<String>> {
    ...
    private fun createKafkaSender(): KafkaSender<PartitionKey, KafkaMessage> {
        val props = mapOf(
            ...
            ProducerConfig.CLIENT_ID_CONFIG to producerId + UUID.randomUUID().toString(),
